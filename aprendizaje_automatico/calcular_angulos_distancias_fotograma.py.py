...
def generar_calculos_csv():
    ...
    ruta_csv = os.path.join(os.path.dirname(os.path.abspath(__file__)), "angulos_distancias_esqueletos_perros.csv")
    with open(ruta_csv, mode='w', newline='') as f:
        writer = csv.writer(f)
        writer.writerows(resultados)

    print("Resultados guardados como angulos_distancias_esqueletos_perros.csv")
