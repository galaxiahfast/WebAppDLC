...
# DIVIDIR EN ENTRENAMIENTO Y VALIDACIÓN 90/10 CON ESTRATIFICACIÓN SEGÚN LA CLASE.
...
for name, model in models:
    ...
    joblib.dump(model, os.path.join(dir_path, f"modelo_{name.replace(' ', '_').lower()}.pkl"))
