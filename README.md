...
Este proyecto utiliza tecnologías, contenidos académicos, recursos visuales de terceros, por lo que se citan los artículos originales que documentan el desarrollo, validación de **[DeepLabCut™️](https://deeplabcut.github.io/DeepLabCut/README.html)** y **[SLEAP™️](https://sleap.ai/)** como pilares importantes de esta herramienta web. Las referencias completas de estas publicaciones, esenciales para comprender los fundamentos metodológicos, perspectivas futuras del análisis automatizado del comportamiento animal mediante aprendizaje profundo, se presentan a continuación.

También se han incorporado recursos visuales como el siguiente [video de un perro en alta resolución](https://www.pexels.com/video/close-up-view-of-a-cute-black-and-tan-short-coated-dog-7682696/) del autor [KoolShooters](https://www.pexels.com/@koolshooters/) bajo licencia libre de Pexels, así como materiales educativos de IBM sobre [aprendizaje automático](https://www.ibm.com/mx-es/think/topics/machine-learning) y [aprendizaje profundo](https://www.ibm.com/es-es/think/topics/deep-learning), con el propósito de facilitar una mejor comprensión para el público general interesado en estas tecnologías.
