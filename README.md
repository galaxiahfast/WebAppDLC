...
Este proyecto integra tecnologías, materiales académicos y elementos visuales que no pertenecen a los desarrolladores de esta aplicación, por esta razón, en apego a principios éticos que exigen el reconocimiento adecuado del trabajo intelectual de terceros, se incluyen referencias completas a los artículos científicos que detallan el origen, la evolución técnica y las capacidades actuales de **[DeepLabCut™️](https://deeplabcut.github.io/DeepLabCut/README.html)** y **[SLEAP™️](https://sleap.ai/)**, plataformas en las que se basa el funcionamiento de esta propuesta web orientada al análisis automatizado de posturas en perros, incorporando además recursos como un [video en alta resolución de un perro](https://www.pexels.com/video/close-up-view-of-a-cute-black-and-tan-short-coated-dog-7682696/) creado por el autor [KoolShooters](https://www.pexels.com/@koolshooters/), disponible bajo licencia libre a través de la plataforma Pexels, así como materiales formativos de IBM sobre [aprendizaje automático](https://www.ibm.com/mx-es/think/topics/machine-learning) y [aprendizaje profundo](https://www.ibm.com/es-es/think/topics/deep-learning), seleccionados por su claridad conceptual para facilitar la comprensión de los principios computacionales que sustentan este tipo de sistemas basados en redes neuronales profundas dirigidos al público general interesado en estas tecnologías
